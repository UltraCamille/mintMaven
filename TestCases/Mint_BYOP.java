...
public class Mint_BYOP {
 ...
 public void setUp() {
	 ...
	 public void mintVF_IMEIandAddress_4G(String zipcode , String address, String IMEI, String Coverage1, String Device )throws InterruptedException {
		 driver.get("https://qa.mintmobile.com/v3-test/");
		 Thread.sleep(1000);
...
//		 Assert.assertEquals(URL, "https://qa.mintmobile.com/v3-test//plans/" );
//		 Thread.sleep(2000);
	 }
	...
	public static void takeScreenshot(String fileName) throws IOException {
	 ...
	 mintVF_IMEIandAddress_3G("52333", "2418 Quincy Rd", "353001091708306","3G Coverage: POOR", "COMPATIBLE");
	...
	Assert.assertEquals(ResultsText, "The coverage at 6300 Weber Rd is pretty decent, and your Samsung Galaxy S8 Plus is definitely compatible with our service. We suggest you give us a try first to see how we compare to your current service. We have a 7-day money back guarantee, so even though you’re probably a risk taker, there is absolutely no risk to you.");
	 ...
	 public void IMEIandAddress9() throws InterruptedException, IOException {
		 mintVF_IMEIandAddress_3G("52333", "2418 Quincy Rd", "357498082396511","3G Coverage: POOR", "COMPATIBLE");
	...
	Assert.assertEquals(ResultsText, "Nice. The coverage at 8 Highland Avenue is better than nacho fries with extra cheese and your Google Pixel 3a is 100% compatible with our network.");
	 ...
	 mintVF_IMEIandAddress_4G("04732", "32 Blackwater Rd", "359677098824941","4G LTE Coverage: GOOD", "COMPATIBLE");
	 takeScreenshot("IMEIandAddress11");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header())).getText();
	Assert.assertEquals(HeaderText, "OH FOX YEAH");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "Your coverage at 32 Blackwater Rd is super and your Google Pixel 3a is a match made in wireless heaven. Let’s get you a plan.");
	 }
	 @Test (priority = 11)
	...
	Assert.assertEquals(ResultsText, "The coverage at 58 Heidi Circle is pretty decent, and your Google Pixel 3a is definitely compatible with our service. We suggest you give us a try first to see how we compare to your current service. We have a 7-day money back guarantee, so even though you’re probably a risk taker, there is absolutely no risk to you.");
	 ...
	 mintVF_IMEIandAddress_3G("52333", "2418 Quincy Rd", "359677098824941","3G Coverage: POOR", "COMPATIBLE");
	...
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 310 North 4th Street is excellent. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	Assert.assertEquals(HeaderText, "HMMM......");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 6 Centerville Rd is very good. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	Assert.assertEquals(HeaderText, "HMMM......");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 2497 J Lane is pretty decent. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");

	 }
	 @Test (priority = 16)
	 public void IMEIandAddress17() throws InterruptedException, IOException {
	 mintVF_IMEIandAddress_3G("52333", "2418 Quincy Rd", "3515330612345678","3G Coverage: POOR", "NOT COMPATIBLE");
	 takeScreenshot("IMEIandAddress17");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header())).getText();
	Assert.assertEquals(HeaderText, "NOT MINT TO BE");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "Looks like your Galaxy S4 Mini isn’t compatible with our service, the coverage at 2418 Quincy Rd isn’t as mind-blowingly awesome as we’d like to see. Unfortunately, we are not a match in Mint heaven.");
	...
	Assert.assertEquals(HeaderText, "HMMM..");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 8564 49th Avenue Southwest is excellent. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	Assert.assertEquals(HeaderText, "HMMM......");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 44008 Indian Fields Court is very good. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");

	 }
	 @Test (priority = 19)
	 public void IMEIandAddress20() throws InterruptedException, IOException {
	 mintVF_IMEIandAddress_4G("59336", "300 Road 357", "3515330612345678","4G LTE Coverage: FAIR", "NOT COMPATIBLE");
	 takeScreenshot("IMEIandAddress20");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header())).getText();
	Assert.assertEquals(HeaderText, "HMMM......");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 300 Road 357 is pretty decent. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	mintVF_AddressOnly_3G("52333", "2418 Quincy Rd", "3G Coverage: POOR");
	...
	mintVF_AddressOnly_4G("50658", "1112 300th Street", "4G LTE Coverage: FAIR");
	 takeScreenshot("AddressOnly40");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header2())).getText();
	Assert.assertEquals(HeaderText, "PRETTY SWEET");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at the given location, 1112 300th Street is pretty decent. We suggest you give us a try first to see how we compare to your current service. We have a 7-day money back guarantee, so even though you’re probably a risk taker, there is absolutely no risk to you.");
	
	 }
	 @Test (priority = 25)
	 public void AddressOnly43() throws InterruptedException, IOException {
	mintVF_AddressOnly_3G("79040", "8580 County Road M.", "3G Coverage: POOR");
	...
	mintVF_IMEIandZipcode_4G("03842", "359677098824941", "4G LTE Coverage: EXCELLENT" , "COMPATIBLE");
	 takeScreenshot("IMEIandZipcode52");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header())).getText();
	Assert.assertEquals(HeaderText, "FOXTASTIC");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "Nice! The coverage at 03842 is better than nacho fries with extra cheese and your Google Pixel 3a is 100% compatible with our network.");
	...
	Assert.assertEquals(HeaderText, "HMMM..");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 86401 is excellent. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	Assert.assertEquals(HeaderText, "HMMM......");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 96044 is very good. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	Assert.assertEquals(HeaderText, "HMMM......");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 86036 is pretty decent. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");

	 }
	 @Test (priority = 38)
	 public void IMEIandZipcode60() throws InterruptedException, IOException {
	mintVF_IMEIandZipcode_4G("03842", "3515330612345678", "4G LTE Coverage: EXCELLENT" , "NOT COMPATIBLE");
	 takeScreenshot("IMEIandZipcode60");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header2())).getText();
	Assert.assertEquals(HeaderText, "HMMM..");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 03842 is excellent. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	Assert.assertEquals(HeaderText, "HMMM......");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at 79059 is very good. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
	...
	mintVF_IMEIandZipcode_3G("52772", "3515330612345680", "3G Coverage: GOOD" , "NOT COMPATIBLE");
	 takeScreenshot("IMEIandZipcode64");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header())).getText();
	Assert.assertEquals(HeaderText, "OH FOX YEAH");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The 3G coverage at the given location, 52772 is good but there is no LTE coverage. We suggest you give us a try first to see how we compare to your current service. We have a 7-day money back guarantee, so even though you’re probably a risk taker, there is absolutely no risk to you.");
	...
	mintVF_ZipcodeOnly_4G("03842", "4G LTE Coverage: EXCELLENT" );
	...
	mintVF_ZipcodeOnly_3G("52333", "4G LTE Coverage: FAIR" );
	 takeScreenshot("ZipcodeOnly92");
	String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header())).getText();
	Assert.assertEquals(HeaderText, "PRETTY SWEET");
	String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
	Assert.assertEquals(ResultsText, "The coverage at the given location, 52333 is pretty decent. We suggest you give us a try first to see how we compare to your current service. We have a 7-day money back guarantee, so even though you’re probably a risk taker, there is absolutely no risk to you.");
	...
	mintVFincompatibleZipCode("00000");
	 ...
	 public void mintVFBrandModelAddress112() throws InterruptedException, IOException {
		 ...
		 wait.until(ExpectedConditions.elementToBeClickable(hpp.mintVF_dropdown_Model_iPhone8())).click();
		 Thread.sleep(3000);
		 mintVFBrandModelAddressZipcodePart2_3G("3G Coverage: POOR" , "COMPATIBLE");
		 Thread.sleep(3000);
...
Thread.sleep(2000);
		...
		Assert.assertEquals(HeaderText, "HMMM..");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "The coverage at 8564 49th Avenue Southwest is excellent. However, it looks like your HTC Touch 3G isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
...
Thread.sleep(2000);
		...
		Assert.assertEquals(HeaderText, "HMMM......");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "The coverage at 44008 Indian Fields Court is very good. However, it looks like your HTC Touch 3G isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");

	 }
	 @Test (priority = 90)
	 public void mintVFBrandModelAddress127() throws InterruptedException, IOException {
		 mintVFBrandModelAddressPart1("59336" , "300 Road 357");
		 Actions action2 = new Actions(driver);	
		 WebElement Textbox2 = driver.findElement(By.xpath("//div[contains(text(),'Type or Select')]"));
		 action2.moveToElement(Textbox2).click().sendKeys("HTC" + Keys.RETURN).build().perform();
		 Thread.sleep(2000);
...
Thread.sleep(2000);
		 ...
		 Thread.sleep(3000);
		 takeScreenshot("mintVFBrandModelAddress127");
		String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header2())).getText();
		Assert.assertEquals(HeaderText, "HMMM......");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "The coverage at 300 Road 357is pretty decent. However, it looks like your HTC Touch 3G isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");

	 }
	 @Test (priority = 91)
	 public void mintVFBrandModelAddress128() throws InterruptedException, IOException {
		 mintVFBrandModelAddressPart1("52333" , "2418 Quincy Rd");
		 Actions action2 = new Actions(driver);	
		 WebElement Textbox2 = driver.findElement(By.xpath("//div[contains(text(),'Type or Select')]"));
		 action2.moveToElement(Textbox2).click().sendKeys("HTC" + Keys.RETURN).build().perform();
...
action1.moveToElement(Textbox).click().sendKeys("Touch 3G" + Keys.RETURN).build().perform();
Thread.sleep(2000);
		 mintVFBrandModelAddressZipcodePart2_3G("3G Coverage: POOR" , "NOT COMPATIBLE");
		 Thread.sleep(3000);
		 takeScreenshot("mintVFBrandModelAddress128");
		String HeaderText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_result_header2())).getText();
		Assert.assertEquals(HeaderText, "NOT MINT TO BE");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "Looks like your HTC Touch 3G isn’t compatible with our service, the coverage at 2418 Quincy Rd isn’t as mind-blowingly awesome as we’d like to see. Unfortunately, we are not a match in Mint heaven.");
...
Thread.sleep(2000);
		...
		Assert.assertEquals(HeaderText, "NOT MINT TO BE");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "Looks like your HTC Touch 3G isn’t compatible with our service, the coverage at 8580 County Road M isn’t as mind-blowingly awesome as we’d like to see. Unfortunately, we are not a match in Mint heaven.");
	 ...
	 public void mintVFBrandModelZipcode147() throws InterruptedException {
		...
		Assert.assertEquals(HeaderText, "FOXTASTIC");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "Nice! The coverage at 86401 is better than nacho fries with extra cheese and your Galaxy S4 Mini is 100% compatible with our network.");
...
Thread.sleep(2000);
	  ...
	  Thread.sleep(2000);
		...
		Assert.assertEquals(HeaderText, "HMMM......");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "The coverage at 03842 is very good. However, it looks like your Galaxy S4 Mini isn’t compatible with us. No biggie, upgrade your phone to one that is 4G LTE, and VoLTE friendly before you join Mint. We've got options.");
...
Thread.sleep(2000);
		...
		Assert.assertEquals(HeaderText, "OH FOX YEAH");
		String ResultsText = wait.until(ExpectedConditions.visibilityOfElementLocated(hpp.mintVF_text_subtitle())).getText();
		Assert.assertEquals(ResultsText, "Your coverage at 79059 is super and your Galaxy S4 Mini is a match made in wireless heaven. Let’s get you a plan.");
